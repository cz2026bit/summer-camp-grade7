      ...
      units: [
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 一分钟唤醒六年级的记忆", steps: [
              ...
              { text: "例如 1/2 + 1/3,通分成 3/6 + 2/6,等于 5/6。", emoji: "🧮", scene: { type: "fraction", a: [1,2], b: [1,3], r: [5,6] } },
        ...
        },
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 一个让欧洲人害怕了一千年的数", steps: [
              ...
              { text: "为什么需要负数?因为生活中到处是相反意义的量:零上和零下、收入和支出、地上和地下。", emoji: "⚖️", scene: { type: "thermo", from: 3, to: -3 } },
              { text: "只说「3」不够,必须说清楚方向:+3 还是 −3。负号,本质上是一个「方向标记」。", emoji: "🧭", scene: { type: "numberline", from: 3, to: -3 } },
              { text: "记住:0 既不是正数也不是负数,它是正负世界的分界线。", emoji: "🚪", scene: { type: "numberline", from: -2, to: 0 } }
            ] },
            { type: "thermometer" }
          ],
          q: null
        },
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 一条线管住所有的数", steps: [
              { text: "数学家想了一个绝妙的办法:画一条直线,规定原点、正方向和单位长度,这就是数轴。", emoji: "📏", scene: { type: "numberline", from: 0, to: 5 } },
              { text: "0 坐在原点,正数排在右边,负数排在左边,每个数都有自己唯一的座位。", emoji: "💺", scene: { type: "numberline", from: 5, to: -5 } },
              { text: "数轴上有一条铁律:越往右越大,越往左越小。", emoji: "👉", scene: { type: "numberline", from: -8, to: 8 } },
              { text: "所以 −2 比 −6 大!因为 −2 的座位在 −6 的右边。", emoji: "🤯", scene: { type: "numberline", from: -6, to: -2 } },
          ...
          q: { type: "choice", points: 15, voice: "zh",
            ...
            explainSteps: [
              ...
              { text: "第②句是个大陷阱:比较 −0.5 和 −1,要看数轴上的位置。", emoji: "⚠️", scene: { type: "numberline", from: -1, to: -0.5 } },
              { text: "−0.5 在 −1 的右边,所以 −0.5 反而大!负数的世界,数字部分越大,数反而越小。", emoji: "🔄", scene: { type: "numberline", from: -1, to: -0.5 } },
              { text: "第③句:从 −3 出发向右走 5 格:−3 → −2 → −1 → 0 → 1 → 2,正好是 +2,正确!", emoji: "🚶", scene: { type: "numberline", from: -3, to: 2 } },
        ...
        },
        {
          ...
          q: { type: "fill", points: 20, boss: true, voice: "zh",
            ...
            explainSteps: [
              ...
              { text: "第一段:从 22℃ 降到 0℃,一共要降 22℃,每分钟降 2℃,需要 22 除以 2 等于 11 分钟。", emoji: "1️⃣", scene: { type: "thermo", from: 22, to: 0 } },
              { text: "第二段:从 0℃ 降到 −6℃,注意!这段跨进了负数区,但降温幅度就是 6℃,需要 3 分钟。", emoji: "2️⃣", scene: { type: "thermo", from: 0, to: -6 } },
              { text: "很多同学错在第二段:0 到 −6 的距离是 6,不是别的。数轴上数格子就明白了。", emoji: "📏", scene: { type: "numberline", from: 0, to: -6 } },
        ...
        },
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 为什么英语要有三个「是」?", steps: [
              ...
              { text: "规则其实很简单:我用 am;单数(他、她、它、一个东西)用 is;你、复数(我们、他们、很多东西)用 are。", emoji: "📐", scene: { type: "match", groups: [ { head: "am", items: ["I"] }, { head: "is", items: ["he / she / it", "单数名词"] }, { head: "are", items: ["you / we / they", "复数名词"] } ] } },
              ...
              { text: "最大的陷阱:主语是「A 和 B」两个人时,算复数,要用 are!比如 My brother and I are students。", emoji: "⚠️", scene: { type: "match", groups: [ { head: "are ✅", items: ["My brother and I", "Li Ming and his sister"] }, { head: "is ✅", items: ["My brother", "The book"] } ] } }
            ] },
      ...
      units: [
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 「和」字居然有 5 种读音?", steps: [
              { text: "「和」是汉语里的变音大王:和平的 hé,应和的 hè,和面的 huó,和药的 huò,还有打麻将的 hú!", emoji: "🀄", scene: { type: "char", char: "和", pinyins: ["hé 和平", "hè 应和", "huó 和面", "huò 和药", "hú 和牌"], highlight: -1 } },
              { text: "怎么记?密码只有四个字:据义定音——先想意思,再定读音。", emoji: "🔑" },
              { text: "「应和」的意思是声音相互呼应,一唱一和,这时读第四声 hè。", emoji: "🎶", scene: { type: "char", char: "和", pinyins: ["hé 和平", "hè 应和", "huó 和面", "huò 和药", "hú 和牌"], highlight: 1 } },
        ...
        },
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 曹操登山看海,看出了什么?", steps: [
              ...
              { text: "前面几句写实景:水何澹澹,山岛竦峙,树木丛生,秋风萧瑟,洪波涌起——大海在他眼前翻腾。", emoji: "🌊", scene: { type: "sea", phase: "waves" } },
              { text: "然后奇迹发生了:日月之行,若出其中;星汉灿烂,若出其里。", emoji: "🌌", scene: { type: "sea", phase: "sun" } },
              { text: "太阳月亮的运行、灿烂的银河,好像都从这片大海中升起——这还是眼睛看到的景象吗?不,这是想象!", emoji: "💭", scene: { type: "sea", phase: "stars" } },
              { text: "曹操把大海写得能吞吐日月星辰,其实是在说:我的胸怀,也装得下整个天下。这种手法叫「借景抒情」。", emoji: "❤️‍🔥", scene: { type: "sea", phase: "stars" } },
      ...
      units: [
        {
          ...
          blocks: [
            { type: "lesson", title: "▶ 一百七十万年的故事,从一颗牙齿讲起", steps: [
              ...
              { text: "长江边的河姆渡人,种水稻,住干栏式房屋:房子架在木桩上,悬空!", emoji: "🏠", scene: { type: "house" } },
              { text: "黄河边的半坡人,种粟(小米),住半地穴式房屋:房子挖进地下半截!", emoji: "🕳️", scene: { type: "house" } },
          ...
          q: { type: "choice", points: 15, voice: "zh",
            ...
            explainSteps: [
              ...
              { text: "河姆渡在长江流域,气候潮湿多雨,房子贴地就会发霉、进水、生虫,所以架空——干栏式,通风又防潮。", emoji: "🌧️", scene: { type: "house" } },
              { text: "半坡在黄河流域,冬天寒冷干燥,把房子挖进地下半截,土层就像天然棉被,冬暖夏凉。", emoji: "❄️", scene: { type: "house" } },
